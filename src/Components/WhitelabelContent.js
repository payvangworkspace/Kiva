  ...
  return (
    <div className="whitelabel-container">
      <div className="whitelabel-text">
        ...
        Kiva Pays Offers White label solution to all Business owners which allows easy customization of Checkout look-and-feel with your Business logo and brand color.
        </p>
        <p>
